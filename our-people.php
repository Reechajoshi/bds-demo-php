    	...
    	<div class="container">
           ...
           <?php include"header.php"; ?>
            ...
            <div class="span-16">
            	<?php 
include "conn.php";
$about_qry = mysql_query("select * from pages where page_title='About - Resources - Our People'");
...
?>
 ...
 <div class="aboutcon feilds-d" style="margin-top:5px;">            
	<?php echo $about['page_desc']; ?>
    </div>     
            ...
            <div class="span-8 notopmargin last">
                ...
                <div class="span-8 last side-bar">
                    ...
                    <ul class="navigation-sidebar">
                        ...
                        <li><a href="about-accredition.php">Accredition</a></li>
                        <li class="current"><a href="about-resources.php">Resources </a>	
                        <ul>
                        	<li class="current"><a href="our-people.php">Our People</a></li>
