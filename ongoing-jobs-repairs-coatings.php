...
<div class="main-wrapper"> 
  ...
  <div class="container"> 
    ...
    <!-- SUBPAGE CONTENT -->
    <div class="span-16">
      <h3>Ongoing Jobs Repairs &amp; Coatings</h3>
...
<?php 
$i=1;
$ongoing = mysql_query("select * from jobs where category='Ongoing Jobs - Repairs and Coating'");
while($ongoing_jobs=mysql_fetch_array($ongoing))
{        
      		echo "<tr>";
                  echo "<td>".$i."</td>";
                  echo "<td>".$ongoing_jobs['client']."</td>";
                  echo "<td>".$ongoing_jobs['description']."</td>";
                echo "</tr>";
		$i++;
}
?>
    ...
    <div class="span-8 notopmargin last">
      ...
      <div class="span-8 last side-bar">
        <ul class="navigation-sidebar">
          <li ><a href="completed-jobs-list.php">Completed Jobs List</a></li>
          <li class="current"><a href="ongoing-jobs-repairs-coatings.php">Ongoing Jobs Repairs & Coatings</a></li>
