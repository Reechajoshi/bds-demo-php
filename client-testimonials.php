	...
	<div class="main-wrapper">
    	...
    	<div class="container">
           ...
           <?php include"header.php"; ?>
            ...
            <div class="span-16">
            	<h3>Testimonials</h3>
                <p>Our work and our clients speak for us.</p>
                
                

 <div class="item-pattern">
 	<p style="margin-top: 16px">
    	<a href="images/testimonials/testimonials.pdf" target="_blank" style="font-family: Yanone Kaffeesatz;color: #000000;font-size:20px;text-decoration:none">Download Testimonials</a>
   </p>
 </div>
            ...
            <div class="span-8 notopmargin last">
                ...
                <div class="span-8 last side-bar">
                    ...
                    <ul class="navigation-sidebar">
                         ...
                         <li class="current"><a href="client-testimonials.php">Testimonials </a></li>
                    </ul>
                </div>
