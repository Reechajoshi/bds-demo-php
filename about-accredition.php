    	...
    	<div class="container">
           ...
           <?php include "header.php" ?>
            ...
            <div class="span-24 slider-area-inner">
            	<h1 class="colored left">About Us</h1>
            ...
            <div class="span-16">
            	<?php 
include "conn.php";
$about_qry = mysql_query("select * from pages where page_title='About - Accredition'");
$about = mysql_fetch_array($about_qry);
?>
            	<h3><?php echo $about['page_heading']; ?></h3>
                <p><?php echo $about['page_intro']; ?></p>


                
                <div class="item-pattern"><?php echo '<img src="'.str_replace('http://bdsindia.com/','',$about['page_image1']).'" alt=" "/>'; ?></div>
                
<?php 
$pdfqry = mysql_query("select * from accredition");
while($pdf = mysql_fetch_array($pdfqry))
{
?>

          <div class="span-8 last side-bar">
                    <h5><?php echo $pdf['title']; ?></h5>
                        <div class="big-rounded-icon-white left margin15">
                            <div class="icon-white-big icon223-white"></div>
                        </div>
                    <h5><a href="<?php echo $pdf['pdf']; ?>" target="_blank" class="link">Click here to view certificate</a></h5>
            ...
            <div class="span-8 notopmargin last">
                ...
                <div class="span-8 last side-bar">
                    ...
                    <ul class="navigation-sidebar">
                        ...
                        <li><a href="about-thegroup.php">The Group</a></li>
                        <li><a href="about-our-quality-policy.php">Our Quality Policy </a></li>
                        <li><a href="about-hse.php">HSE Protection Policy </a></li>
                        <li class="current"><a href="about-accredition.php">Accredition</a></li>
