...
<?php
include "conn.php";
$datasheetqry1 = mysql_query("select * from downloads where category='Videos'");
while($sheet = mysql_fetch_array($datasheetqry1))
{               
              echo '<h4>'.$sheet['title'].':</h4>';
              echo '<p><iframe width="500" height="315" src="'.$sheet['link'].'" frameborder="0" allowfullscreen></iframe></p>';
}
  ?>              
            ...
            <div class="span-8 notopmargin last">
                ...
                <div class="span-8 last side-bar">
                    ...
                    <ul class="navigation-sidebar">
                            ...
                            <li class="current"><a href="downloads-videos.php">Videos</a></li>
