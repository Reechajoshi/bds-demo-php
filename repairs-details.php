	...
	<div class="main-wrapper">
    	...
    	<div class="container">
           ...
           <?php include"header.php"; ?>
            ...
            <!-- SUBPAGE CONTENT -->
            <div class="span-16">
            	<h3>Repairs & Rehabilitation - Project Details</h3>
                <p>Having undertaken over 250 projects, and with several more in the pipeline, BDS has a wide spectrum of display for the use of our services, over a wide variety of structures.
Read on to have a look at the kind of projects completed and currently being undertaken for some of our clients, in the fields of:
</p>
     
	
    <div class="span-16">
            	<h4>Project category displayed below</h4>
               
            	<div class="section">
					<ul class="tabs">
                        <li class="current">Repairs & Rehabilitation</li>
                    </ul>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>Construction of structure of Sewage Treatment Plant at Renaissance Hotel, Powai.</td>
                        <td>completed</td>
                    </tr>
            ...
            <div class="span-8 notopmargin last">
                ...
                <div class="span-8 last side-bar">
                    ...
                    <ul class="navigation-sidebar">
                        <li><a href="projects.php">New Construction</a></li>
                                <li><a href="projects-distribution-services.php">Distribution Services </a></li>
                                
                             <li class="current"><a href="projects-repairs.php">Repairs & Rehabilitation</a>
                               <ul>
                                    <li class="current"><a href="repairs-details.php">Project Details </a></li>
                         
                                </ul>
                             </li>
                             <li><a href="new-construction-gallery.php">Project Gallery</a></li>
                    </ul>
