...
<div class="main-wrapper"> 
  ...
  <div class="container"> 
    ...
    <div class="span-24 slider-area-inner">
      <h1 class="colored left">Clients</h1>
    ...
    <div class="span-16">
      <h3>Client List</h3>
      <p>By virtue of previous projects, dedication, experience and recommendation by clients to their associates, BDS has acquired an august set of clients over the past decade. Names that make for legendary companies have chosen to use our services.<br />
        Here's a glimpse of some of our vast clientele-</p>
...
<?php 
include "conn.php";
$clientqry = mysql_query("select * from clients order by client asc");
while($clients = mysql_fetch_array($clientqry))
{

          echo '<li class="development">';
          echo '<div class="span-6">';
          echo '<div class="item">';
 echo '<img class="img-preview spec-border" src="auto-thumb.php?src='.str_replace("http://bdsindia.com/","",$clients['image_url']).'&h=150&zc=1" alt="'.$clients['client'].'" /><br /><span style="width:100%;float:left;text-align:center;font-family: Yanone Kaffeesatz;color: #000000;font-size:20px;margin-top:5px; padding-top:4px;border-top:1px dotted #666">'.$clients['client'].'</span></div>';
          echo '</div>';
          echo '</li>';
    ...
    <div class="span-8 notopmargin last">
      ...
      <div class="span-8 last side-bar">
        <ul class="navigation-sidebar">
          <li class="current"><a href="clients.php">Client List </a></li>
