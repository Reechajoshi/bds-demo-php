    	...
    	<div class="container">
           ...
           <?php include"header.php"; ?>
            ...
            <div class="span-16">
            	<?php 
include "conn.php";
$about_qry = mysql_query("select * from pages where page_title='About - Our Quality Policy'");
            ...
            <div class="span-8 notopmargin last">
                ...
                <div class="span-8 last side-bar">
                    ...
                    <ul class="navigation-sidebar">
                        ...
                        <li class="current"><a href="about-our-quality-policy.php">Our Quality Policy </a></li>
