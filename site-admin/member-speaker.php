                                    ...
                                    <div class="box-content no-inner-space">
	                                    	<ul id="sortspeaker">
		                                    	<?php
			                                    	...
			                                    	$result = mysql_query("SELECT distinct a.id,a.fullname, a.designation, a.companylogo, a.profilepic, a.sort FROM member a, sessionrole c WHERE a.id=c.userid and c.roleid=2 order by a.sort") or die(mysql_error());
