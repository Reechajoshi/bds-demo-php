...
<html>
    ...
    <head>
        <meta charset="UTF-8" />
        <title>BDS - Admin Control Panel</title>
                                    ...
                                    <header class="head">
                                        ...
                                        <div class="alignright">
                                            <div class="note small">
                                                <input id="ck" type="checkbox" /> <label for="ck">remember your password?</label>
                                            </div>
                                        </div>
                                        <span class="divider"></span>
                                    </header>
                                    <div class="alert grey air">
                                        <p><strong>No password needed!</strong> Just click login.</p>
                                        <a class="close" href="#">close</a>
                                    </div>
                                    <div class="field fullwidth">
                                        <input type="text" placeholder="Login" data-icon="user" name="usrname"  id="usrname"/>
                                    </div>
                                    <div class="field fullwidth">
                                        <input type="password" placeholder="Password" data-icon="closed-lock" name="pwd" id="pwd" />
                                    </div>
