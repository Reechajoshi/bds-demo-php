                                    ...
                                    <div class="box-content no-inner-space">
                                        <table class="datatable ten-per-page">
                                            ...
                                            <tbody>
                                            	...
                                            	$membersql = mysql_query("select pageid,page_title from pages order by pageid");
                                            	while ($memberresult = mysql_fetch_array($membersql))
                                            		{
	                                            		echo '<tr>';                                                
                                                    echo '<td class="center">'.$memberresult['pageid'].'</td>';
							if($memberresult['page_title']=='About - Accredition')
							{
							echo '<td><a href="accredition.php">'.$memberresult['page_title'].'</a></td>';
							}
							else
							{
                                                    echo '<td><a href="page-details.php?id='.$memberresult['pageid'].'">'.$memberresult['page_title'].'</a></td>';
							}
