...
<div class="main-wrapper"> 
  ...
  <div class="container"> 
    ...
    <!-- SUBPAGE CONTENT -->
    <div class="span-16">
      <h3>Ongoing Jobs Construction</h3>
            ...
            <table id="rowspan" cellspacing="0" class="tablesorter">
              <tbody>
                <tr style="color:#000000">
                  ...
                  <td width="65%">Brief Job Description</td>
                </tr>
<?php 
$i=1;
$construction = mysql_query("select * from jobs where category='Ongoing Jobs - Construction'");
while($construction_jobs=mysql_fetch_array($construction))
{        
      		echo "<tr>";
                  echo "<td>".$i."</td>";
                  echo "<td>".$construction_jobs['client']."</td>";
                  echo "<td>".$construction_jobs['description']."</td>";
                echo "</tr>";
		$i++;
}
?>
    ...
    <div class="span-8 notopmargin last">
      ...
      <div class="span-8 last side-bar">
        <ul class="navigation-sidebar">
          <li class="current"><a href="completed-jobs-list.php">Completed Jobs List</a></li>
          <li ><a href="ongoing-jobs-repairs-coatings.php">Ongoing Jobs Repairs & Coatings</a></li>
                                
                             <li class="current">
                             	<a href="ongoing-jobs-construction.php">Ongoing Jobs Construction</a>
                             </li>
