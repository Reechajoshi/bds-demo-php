...
<?php
	echo("menuInit = function() { try { 
		...
		tabs.addIFrameTab( menuid + 'All',{ name: 'All', iframeURL:'$me?b=projects_all', txtColor: '#28A9D3', txtSelectColor: '#28A9D3', tabLImage: 'images/tabs/tabl.png', tabTImage: 'images/tabs/tabt.png', tabRImage: 'images/tabs/tabr.png', extraBackdrop: '#28A9D3', borderSelect: '#fff 1px solid', userTabControl: false } );
