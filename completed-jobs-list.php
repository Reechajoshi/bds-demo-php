...
<?php 
$i=1;
$completed = mysql_query("select * from jobs where category='Completed Jobs'");
while($completed_jobs=mysql_fetch_array($completed))
{        
      		echo "<tr>";
                  echo "<td>".$i."</td>";
                  echo "<td>".$completed_jobs['client']."</td>";
                  echo "<td>".$completed_jobs['description']."</td>";
                echo "</tr>";
		$i++;
}
?>
