    	...
    	<div class="container">
           ...
           <?php include"header.php"; ?>
            ...
            <div class="span-16">
            	<?php 
include "conn.php";
$about_qry = mysql_query("select * from pages where page_title='Careers - Career Openings'");
                ...
                <div class="span-8 last side-bar">
                    ...
                    <ul class="navigation-sidebar">
                        <li><a href="careers-joinus.php">Why Join Us </a></li>
                            <li class="current"><a href="careers-opening.php">Career Openings</a></li>
                            <li><a href="careers-post-your-resume.php">Post Your Resume</a></li>
                            <li><a href="careers-enquiry.php">Enquiry </a></li>                       
                    </ul>
                </div>
