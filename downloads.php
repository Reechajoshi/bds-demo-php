...
<?php
include "conn.php";
$brochureqry = mysql_query("select * from downloads where category='e-brochure'");
while($brochure = mysql_fetch_array($brochureqry))
{


                echo '<p class="link"><a href="'.$brochure['link'].'" target="_blank">'.$brochure['title'].': Click here to download brochure</a></p>';
            ...
            <div class="span-8 notopmargin last">
                ...
                <div class="span-8 last side-bar">
                    ...
                    <ul class="navigation-sidebar">
                            <li class="current"><a href="downloads.php">e-brochure </a></li>
                            <li><a href="downloads-datasheets.php">Datasheets </a></li>
