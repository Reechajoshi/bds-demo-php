    	...
    	<div class="container">
           ...
           <?php include"header.php"; ?>
            ...
            <div class="span-24 slider-area-inner">
            	<h1 class="colored left">Downloads</h1>
            ...
            <div class="item-pattern"><img src="images/careers/careers-sample.jpg" alt=" "/></div>
 <h4>Polyurea Data Sheets</h4>
 <?php
include "conn.php";
$datasheetqry1 = mysql_query("select * from downloads where category='Datasheets' AND heading='Polyurea Data Sheets'");
while($sheet = mysql_fetch_array($datasheetqry1))
{               
               
                
             echo '<p class="link"><a href="'.$sheet['link'].'" target="_blank">'.$sheet['title'].'</a></p>';
  }
?>
                
                <h4>Corrosion Mitigation Data Sheets</h4>
<?php

$datasheetqry2 = mysql_query("select * from downloads where category='Datasheets' AND heading='Corrosion Mitigation Data Sheets'");
while($sheet2 = mysql_fetch_array($datasheetqry2))
{               
               
                
             echo '<p class="link"><a href="'.$sheet2['link'].'" target="_blank">'.$sheet2['title'].'</a></p>';
  }
?>
            ...
            <div class="span-8 notopmargin last">
                ...
                <div class="span-8 last side-bar">
                    ...
                    <ul class="navigation-sidebar">
                            <li><a href="downloads.php">e-brochure </a></li>
                            <li class="current"><a href="downloads-datasheets.php">Datasheets </a></li>
                            <li><a href="downloads-videos.php">Videos</a></li>
                            <li><a href="downloads-white-papers.php">White Papers</a></li>
