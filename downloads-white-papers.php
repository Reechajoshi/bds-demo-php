...
<body>
 ...
 <?php
include "conn.php";
$datasheetqry1 = mysql_query("select * from downloads where category='White Papers'");
while($sheet = mysql_fetch_array($datasheetqry1))
{               
               
                
             echo '<p class="link"><a href="'.$sheet['link'].'" target="_blank">'.$sheet['title'].': Click here to download</a></p>';
  }
?>
            ...
            <div class="span-8 notopmargin last">
                ...
                <div class="span-8 last side-bar">
                    ...
                    <ul class="navigation-sidebar">
                            ...
                            <li class="current"><a href="downloads-white-papers.php">White Papers</a></li>
