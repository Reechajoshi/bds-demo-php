	...
	<div class="main-wrapper">
    	...
    	<div class="container">
           ...
           <?php include"header.php"; ?>
            ...
            <!-- SUBPAGE CONTENT -->
            <div class="span-16">
            	<h3>New Construction - Project Details</h3>
            ...
            <div class="span-8 notopmargin last">
                ...
                <div class="span-8 last side-bar">
                    ...
                    <ul class="navigation-sidebar">
                        <li class="current"><a href="projects.php">New Construction</a>
                                <ul>
                                    <li class="current"><a href="new-construction-details.php">Project Details </a></li>
                             ...
                             <li><a href="projects-repairs.php">Repairs & Rehabilitation</a>
